...
gigas<-read.csv("data/raja_gigas.csv")
...
#saveRDS(plot_3d,'research_files/plot_3d.RDs')
```
...
![An Electricblue temperature logger and intertidal oysters in Great Bay, NH](images/temp_loggers.JPEG){fig-align="center" width="300"}
...
![I use wavelet analysis to understand periodicities within the thermal environment. Here, we see the impacts of tidal (8 hour) and solar (24 hour) cycles on a reef in Madagascar.](images/wavelet.png)
