...
There are many methods for downloading tide prediction data. The [@rnoaa], [@rtide], and [@MarineTides] packages are three convenient in-R methods to download data.
...
```{r,echo=F,warning=F,results='hide',echo=F}
require(rnoaa)
require(MarineTides)
require(rtide)
require(data.table)
...
system.time(rtide_output_seavey<-tide_height(
  ...
  minutes = 6L, #nice! We can select our precision
